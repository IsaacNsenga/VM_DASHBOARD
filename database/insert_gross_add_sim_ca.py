...
sheet_name = "gross_add_sim_ca"  # Feuille à importer
...
try:
    for index, row in df.iterrows():
        ...
        for col in df.columns[1:]:  # Colonnes de dates
            try:
                ...
                sql = """
                    INSERT INTO gross_add_sim_ca (numero_mpos, date_releve, total_gross_add)
                    VALUES (%s, %s, %s)
